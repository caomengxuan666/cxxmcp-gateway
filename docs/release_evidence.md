...
| Runtime component is explicit | `tests/fixtures/package_smoke/runtime_consumer.cpp` move construction, typed runtime, hosted endpoint, and observer coverage; missing-runtime component failure tests |
